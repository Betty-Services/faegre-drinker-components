(() => ({
  name: 'ANDOR TextField Filtering',
  ...
  jsx: (() => {
    ...
    const changeHandler = event => {
      ...
      // Now make this able to process the deeper arrays, then test whether the GraphQL is on board or whether the _and operators need to be added,
      ...
      if (eventVariable.includes(' AND ')) {
        ...
        temp.forEach((value, index) => {
          if (value.includes(' OR ')) {
            ...
            const temp3 = { and: temp2 };
            eventVariable[index] = temp3;
          } else {
            const temp2 = { and: value };
