  ...
  structure: [
    {
      ...
      options: [
        ...
        // Row click functionaliteit hebben we er voor nu uitgehaald wegen een onduidelijke bug
        // {
        //   value: false,
        //   label: 'Row click',
        //   key: 'rowClick',
        ...
        {
          type: 'VARIABLE',
          label: 'Rows selection label',
          key: 'labelRowsSelection',
          value: ['rows selected'],
          configuration: {
            condition: {
              type: 'SHOW',
        ...
        {
          type: 'COLOR',
          label: 'Checkbox color (Unchecked)',
          key: 'checkboxColor',
          value: 'Primary',
          configuration: {
            condition: {
