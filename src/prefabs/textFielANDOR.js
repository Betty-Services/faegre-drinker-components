(() => ({
  name: 'ANDOR Text Field Filtering',
  icon: 'TextInputIcon',
  category: 'FROM',
  ...
  structure: [
    {
      ...
      options: [
        ...
        {
          type: 'MODEL',
          label: 'Model displayed on the Table',
          key: 'modelTable',
          value: '',
          configuration: {
            condition: {
        ...
        {
          type: 'PROPERTY',
          label: 'Route from the model of the Table',
          key: 'valuePropertyTable',
          value: '',
          configuration: {
            dependsOn: 'modelTable',
            condition: {
              type: 'SHOW',
              option: 'optionType',
              comparator: 'EQ',
